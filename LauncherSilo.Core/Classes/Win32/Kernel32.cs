...
namespace Win32 {
    public abstract class Kernel32 {
        ...
        public const int FILE_ATTRIBUTE_SPARSEFILE = 512;

        public const int FILE_ATTRIBUTE_REPARSEPOINT = 1024;

        public const int FILE_ATTRIBUTE_COMPRESSED = 2048;

        public const int FILE_ATTRIBUTE_OFFLINE = 4096;

        public const int FILE_ATTRIBUTE_NOTCONTENTINDEXED = 8192;
        ...
        [DllImport("kernel32")]
        public static extern int FindFirstFileEx(string lpFileName, FINDEX_INFO_LEVELS fInfoLevelId, out WIN32_FIND_DATA lpFindFileData, FINDEX_SEARCH_OPS fSearchOp, IntPtr lpSearchFilter, int dwAdditionalFlags);
        ...
        [DllImport("kernel32")]
        public static extern int ReadFile(IntPtr hFile, IntPtr lpBuffer, uint nNumberOfBytesToRead, out uint lpNumberOfBytesRead, ref OVERLAPPED lpOverlapped);
