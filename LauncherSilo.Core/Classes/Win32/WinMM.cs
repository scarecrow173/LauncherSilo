...
namespace Win32
{
	public abstract class WinMM
	{
		...
		[DllImport("winmm")]
		public static extern int midiInGetDevCaps(uint uDeviceID, ref MIDIINCAPS lpCaps, uint uSize);
		...
		[DllImport("winmm")]
		public static extern int midiInOpen(out IntPtr lphMidiIn, uint uDeviceID, IntPtr dwCallback, IntPtr dwInstance, uint dwFlags);
		...
		[DllImport("winmm")]
		public static extern int midiOutOpen(out IntPtr lphMidiOut, int uDeviceID, IntPtr dwCallback, IntPtr dwInstance, uint dwFlags);
