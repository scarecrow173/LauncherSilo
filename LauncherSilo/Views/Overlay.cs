...
namespace LauncherSilo.Views
{
    ...
    public class Overlay : Window
    {
        ...
        public Overlay()
        {
            ...
            this.MouseLeftButtonDown += Window_MouseButtonDown;
            this.MouseRightButtonDown += Window_MouseButtonDown;
        }
        protected virtual void OnPreShowOverlay()
        {

        }
        protected virtual void OnPostShowOverlay()
        {
        ...
        protected virtual void OnPreHideOverlay()
        {

        }
        protected virtual void OnPostHideOverlay()
        {
